...
class Map extends Component {
  ...
  navigation() {
    if (
      this.state.pathView == null &&
      this.state.pathTopic == null &&
                ...
                <Form size="md">
                  <FloatingLabel label="Select a spot" size="xs">
                    <Form.Control
                      ...
                      size="xs"
                      onClick={() => {
                        if (this.refs.select_spot_form_ref.value === "") {
                          this.getSpot();
                        }
                      }}
                    >
                  ...
                  <ButtonGroup className="gap-1">
                    <Button
                      ...
                      variant="secondary"
                    >
                      GOTO <IoNavigateOutline />
                    </Button>
                    <Button
                      onClick={() => {
                        this.setState({
                          show_set_spot: !this.state.show_set_spot,
                        });
                      }}
                      variant="secondary"
                    >
...
/* class Map extends Component {
  state = {
    ros: null,
    viewer: null,
@ -72,7 +754,7 @@ class Map extends Component {
  }
}
