...
class RobotState extends Component {
  ...
  getRobotState() {
    ...
    pose_subscriber1.subscribe((message) => {
      ...
      this.setState({
        orientation1: this.getOrientationFromQuaternion(
    ...
    pose_subscriber2.subscribe((message) => {
      ...
      this.setState({
        orientation2: this.getOrientationFromQuaternion(
          message.pose.pose.orientation
        ),
      });
    });
      ...
      <div>
        <ListGroup className="mt-3">
          ...
          <ListGroup.Item variant="dark">
            <Row>
              <h3 className="text-center">Robot</h3>
            </Row>
            <Row>
              <Col align="center">
                ...
                <p className="m-0">
                  Linear&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:{" "}
                  {this.state.linear_velocity1.toFixed(2)}
                </p>
                <p className="m-0">
                  Angular : {this.state.angular_velocity1.toFixed(2)}
                </p>
              </Col>
              <Col align="center">
